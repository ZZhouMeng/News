					...
					<div class="collapse navbar-collapse" id="main-menu">
						<ul class="menu">
							...
							<%
								...
								rs.close();
							%>
							<li  class="nav-current" role="presentation"><a href="/news/postNews.jsp">发表新闻</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<main class="col-md-8 main-content">
				 	<article class="post">	
						<div class="post-content">
							<form class="form-horizontal"  name="form" id="form" action="checkpost.jsp" method="post">
